...
protected:
  ...
  // log
  GLboolean _ListOpenGLErrors(const char* file_name,
                              GLint line,
                              std::ostream& output = std::cout)
    const; // returns GL_TRUE if an OpenGL error occurred, GL_FALSE otherwise
...
public:
  ...
  GLboolean SetUniformVariable2ui(const GLchar* name,
                                  GLuint parameter_1,
                                  GLuint parameter_2) const;
  GLboolean SetUniformVariable3ui(const GLchar* name,
                                  GLuint parameter_1,
                                  GLuint parameter_2,
                                  GLuint parameter_3) const;
  GLboolean SetUniformVariable4ui(const GLchar* name,
                                  GLuint parameter_1,
                                  GLuint parameter_2,
                                  GLuint parameter_3,
                                  GLuint parameter_4) const;

  GLboolean SetUniformVariable1fv(const GLchar* name,
                                  GLsizei count,
                                  const GLfloat* value) const;
  GLboolean SetUniformVariable2fv(const GLchar* name,
                                  GLsizei count,
                                  const GLfloat* value) const;
  GLboolean SetUniformVariable3fv(const GLchar* name,
                                  GLsizei count,
                                  const GLfloat* value) const;
  GLboolean SetUniformVariable4fv(const GLchar* name,
                                  GLsizei count,
                                  const GLfloat* value) const;
