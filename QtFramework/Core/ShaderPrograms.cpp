...
GLboolean
ShaderProgram::_ListOpenGLErrors(const char* file_name,
                                 GLint line,
...
GLvoid
ShaderProgram::_ListVertexShaderInfoLog(ostream& output) const
{
  ...
  if (info_log_length > 0) {
    ...
    if (!info_log)
      throw Exception("ShaderProgram::_ListVertexShaderInfoLog - Could not "
                      "allocate information log buffer!");

    glGetShaderInfoLog(
      _vertex_shader, info_log_length, &chars_written, info_log);
...
GLvoid
ShaderProgram::_ListFragmentShaderInfoLog(ostream& output) const
{
  GLint info_log_length = 0;
  GLint chars_written = 0;
  GLchar* info_log = 0;
  ...
  if (info_log_length > 0) {
    info_log = new GLchar[info_log_length];
    if (!info_log)
      throw Exception("ShaderProgram::_ListFragmentShaderInfoLog - Could not "
                      "allocate information log buffer!");

    glGetShaderInfoLog(
      _fragment_shader, info_log_length, &chars_written, info_log);
...
GLvoid
ShaderProgram::_ListProgramInfoLog(ostream& output) const
{
  GLint info_log_length = 0;
  GLint chars_written = 0;
  GLchar* info_log = 0;
  ...
  if (info_log_length > 0) {
    info_log = new GLchar[info_log_length];
    if (!info_log)
      throw Exception("ShaderProgram::_ListProgramInfoLog - Could not allocate "
                      "information log buffer!");
...
GLvoid
ShaderProgram::_ListValidateInfoLog(ostream& output) const
{
...
GLint
ShaderProgram::GetUniformVariableLocation(const GLchar* name,
...
GLboolean
ShaderProgram::InstallShaders(const string& vertex_shader_file_name,
                              ...
                              std::ostream& output)
{
  ...
  // 2) setting the source codes for the shaders
  {
    ...
    glShaderSource(
      _fragment_shader, 1, &pointer_to_fragment_shader_source, NULL);
  ...
  // 3) compiling the vertex shader
  {
    ...
    if (logging_is_enabled) {
      ...
      output << (_vertex_shader_compiled ? "\tSuccessful." : "\tUnsuccessful.")
             << endl
             << "Done." << endl
             << endl;
    }
  ...
  // 4) compiling the fragment shader
  {
    ...
    glGetShaderiv(
      _fragment_shader, GL_COMPILE_STATUS, &_fragment_shader_compiled);
  ...
  // 5) creating the program object
  {
    ...
    if (logging_is_enabled)
      output
        << "\tAttaching vertex and fragment shaders to the program object..."
        << endl;
...
GLboolean
ShaderProgram::SetUniformVariable1i(const GLchar* name, GLint parameter) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable2i(const GLchar* name,
                                    GLint parameter_1,
...
GLboolean
ShaderProgram::SetUniformVariable3i(const GLchar* name,
                                    GLint parameter_1,
                                    GLint parameter_2,
...
GLboolean
ShaderProgram::SetUniformVariable4i(const GLchar* name,
                                    GLint parameter_1,
                                    GLint parameter_2,
                                    GLint parameter_3,
...
GLboolean
ShaderProgram::SetUniformVariable1f(const GLchar* name, GLfloat parameter) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable2f(const GLchar* name,
                                    GLfloat parameter_1,
...
GLboolean
ShaderProgram::SetUniformVariable3f(const GLchar* name,
                                    GLfloat parameter_1,
                                    GLfloat parameter_2,
...
GLboolean
ShaderProgram::SetUniformVariable4f(const GLchar* name,
                                    GLfloat parameter_1,
                                    GLfloat parameter_2,
                                    GLfloat parameter_3,
...
GLboolean
ShaderProgram::SetUniformVariable1ui(const GLchar* name, GLuint parameter) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable2ui(const GLchar* name,
                                     GLuint parameter_1,
                                     GLuint parameter_2) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable3ui(const GLchar* name,
                                     GLuint parameter_1,
                                     GLuint parameter_2,
                                     GLuint parameter_3) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable4ui(const GLchar* name,
                                     GLuint parameter_1,
                                     GLuint parameter_2,
                                     GLuint parameter_3,
                                     GLuint parameter_4) const
{
  if (!_program)
    return GL_FALSE;
...
GLboolean
ShaderProgram::SetUniformVariable1fv(const GLchar* name,
                                     GLsizei count,
...
GLboolean
ShaderProgram::SetUniformVariable2fv(const GLchar* name,
                                     GLsizei count,
                                     const GLfloat* value) const
{
  if (!_program)
...
GLboolean
ShaderProgram::SetUniformVariable3fv(const GLchar* name,
                                     GLsizei count,
                                     const GLfloat* value) const
{
  if (!_program)
...
GLboolean
ShaderProgram::SetUniformVariable4fv(const GLchar* name,
                                     GLsizei count,
                                     const GLfloat* value) const
{
  if (!_program)
...
GLvoid
ShaderProgram::Enable(GLboolean logging_is_enabled, ostream& output) const
{
