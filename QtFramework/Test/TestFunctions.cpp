...
DCoordinate3
spiral_on_cone::d0(GLdouble u)
{
  return DCoordinate3(u * cos(u), u * sin(u), u);
}

DCoordinate3
spiral_on_cone::d1(GLdouble u)
{
...
DCoordinate3
roseCurve::d2(GLdouble u)
{
  return DCoordinate3(-3 * (3 * cos(3 * u) * cos(u) - sin(u) * sin(3 * u)) -
                        1 * cos(u) * (1 / 2 + cos(3 * u)) + 3 * sin(u) * sin(u),
                      -3 * (3 * cos(3 * u) * sin(u)) + sin(3 * u) * cos(u) -
                        1 * sin(u) * (1 / 2 + cos(3 * u)) -
                        3 * cos(u) * sin(3 * u));
}
